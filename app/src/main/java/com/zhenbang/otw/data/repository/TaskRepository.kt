...
import com.zhenbang.otw.data.local.DeptUser
import com.zhenbang.otw.data.local.DeptUserDao
import com.zhenbang.otw.data.local.SubTask
import com.zhenbang.otw.data.local.SubTaskDao
import com.zhenbang.otw.data.local.Task
import com.zhenbang.otw.data.local.TaskAssignment
import com.zhenbang.otw.data.local.TaskAssignmentDao
import com.zhenbang.otw.data.local.TaskDao
...
class TaskRepository(
    ...
    suspend fun updateTask(task: Task, userEmails: List<String>, subTasks: List<SubTask> = emptyList()) {
        withContext(Dispatchers.IO) {
            ...
            val existingSubTasks =
                subTaskDao.getSubTasksByTaskId(task.taskId).firstOrNull() ?: emptyList()
